...
trait--datasets from \NUM{12} species, with architecture, splits and tuning held
...
the calibration slope (Figure~\ref{fig:simulation}; Section~\ref{sec:res-calibration}).
...
predictive ability in Section~\ref{sec:res-batch}.
...
trait--dataset combinations across \NUM{12} species. (i) \emph{EasyGeSe}
...
\paragraph{Statistical analysis.} For each cell we average over folds and form
...
addressed directly in Section~\ref{sec:res-splits}.)
...
(Section~\ref{sec:res-sorghum}) are proprietary and not redistributed; all other
...
\caption{The 101 trait--dataset combinations across 12 species (10 from EasyGeSe,
...
\IfFileExists{figures/fig1_geometry.pdf}{\includegraphics[width=\linewidth]{figures/fig1_geometry.pdf}}{}
\caption{Geometry of the standardized-MSE / Pearson identity (Proposition~\ref{prop:1}).}
\label{fig:geometry}
\end{figure}
\begin{figure}[t]\centering
\IfFileExists{figures/fig2_simulation.pdf}{\includegraphics[width=\linewidth]{figures/fig2_simulation.pdf}}{}
...
\end{figure}
\begin{figure}[t]\centering
\IfFileExists{figures/fig3_datasets.pdf}{\includegraphics[width=\linewidth]{figures/fig3_datasets.pdf}}{}
\caption{Dataset map: size, dimensionality and predictability across species.}
\label{fig:datasets}
\end{figure}
\begin{figure}[t]\centering
\IfFileExists{figures/fig4_loss_comparison.pdf}{\includegraphics[width=\linewidth]{figures/fig4_loss_comparison.pdf}}{}
\caption{Loss comparison: $\Delta$ versus MSE for Pearson, hybrid and CCC losses.}
\label{fig:loss}
\end{figure}
\begin{figure}[t]\centering
\IfFileExists{figures/fig5_calibration.pdf}{\includegraphics[width=\linewidth]{figures/fig5_calibration.pdf}}{}
\caption{Affine calibration restores scale and offset while leaving Pearson unchanged.}
\label{fig:calibration}
\end{figure}
\begin{figure}[t]\centering
\IfFileExists{figures/fig6_meta.pdf}{\includegraphics[width=\linewidth]{figures/fig6_meta.pdf}}{}
