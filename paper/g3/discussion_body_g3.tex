...
universal: pooling all four neural-network losses, in $0.90\%$ ($<1\%$) of folds
...
in magnitude), and is in fact worse for the CNN ($+0.080$). The pooled nulls,
...
the hybrid loss worsened RMSE for the CNN ($+0.080$), so a calibrated-RMSE benefit
